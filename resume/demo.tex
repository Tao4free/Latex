...
\begin{wrapfigure}{l}{0.5\textwidth}
	\vspace*{-2em}
		\includegraphics[width=0.15\textwidth]{./boar.jpg}
\end{wrapfigure}
...
\PersonalEntry{Mail}{\url{tao4free@gmail.com}}

%%% Education
%%% ------------------------------------------------------------
\NewPart{Education}{}

\EducationEntry{MSc. Civil and Environmental Engineering}{2015-2017}{Chuo University Japan}{Enrolled in Program for Capacity Building in Global Water-Environmental Engineering.}
\sepspace
